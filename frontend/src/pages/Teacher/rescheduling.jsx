    ...
    return (
        <article className="rounded-[16px] border border-slate-200 bg-white p-4 shadow-sm">
            ...
            <button
                ...
                className="mt-4 inline-flex w-full items-center justify-center gap-2 rounded-lg bg-[#06b6d4] px-4 py-2.5 text-sm font-medium text-white transition hover:brightness-95"
            >
                <Send size={14} />
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            >
                ...
                <div className="mt-5 flex gap-3 border-t border-slate-200 pt-4">
                    ...
                    <button
                        type="submit"
                        className="w-full rounded-xl bg-[#06b6d4] py-2.5 text-sm font-semibold text-white transition hover:brightness-95"
                    >
