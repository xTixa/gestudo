    ...
    return (
        <section className="space-y-5">
            ...
            <button
                ...
                className="inline-flex items-center justify-center gap-2 rounded-full bg-lime-400 px-5 py-2.5 text-sm font-semibold text-slate-900 transition hover:bg-lime-300"
            >
                <Edit3 size={16} />
                Editar perfil
            </button>
