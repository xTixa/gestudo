...
const ESTADO_CELL_BG = {
    falta: 'bg-rose-50',
    reposta: 'bg-blue-50',
    presente: 'bg-emerald-50',
};

const ESTADO_TEXT_COLOR = {
    falta: 'text-rose-700',
    reposta: 'text-blue-700',
                                ...
                                {Array.from({
                                    ...
                                    return (
                                        <td
                                            ...
                                            className={`h-10 border border-slate-900 px-1 py-1 text-center align-middle ${
                                                ESTADO_CELL_BG[presenca?.estado] || 'bg-white'
                                            }`}
                                        >
                                            {presenca ? (
                                                <div className="mx-auto text-center leading-tight">
                                                    ...
                                                    <div
                                                        className={`text-xs font-bold ${
                                                            ESTADO_TEXT_COLOR[presenca.estado] ||
                                                            'text-slate-500'
                                                        }`}
                                                    >
                                                        {presenca.label}
                ...
                <div className="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm lg:col-span-2">
                    ...
                    <div className="mt-3 flex flex-wrap gap-3 text-xs text-slate-500">
                        <span className="inline-flex items-center gap-1.5">
                            <span className="inline-flex h-4 w-4 items-center justify-center rounded bg-emerald-50 text-[10px] font-bold text-emerald-700">
                                P
                            </span>
                            Presente
                        </span>
                        <span className="inline-flex items-center gap-1.5">
                            <span className="inline-flex h-4 w-4 items-center justify-center rounded bg-rose-50 text-[10px] font-bold text-rose-700">
                                F
                            </span>
                            Falta
                        </span>
                        <span className="inline-flex items-center gap-1.5">
                            <span className="inline-flex h-4 w-4 items-center justify-center rounded bg-blue-50 text-[10px] font-bold text-blue-700">
                                R
                            </span>
                            Reposta
                        </span>
