...
function extrairProfessoresUnicos(atividadesPorDia) {
...
function filtrarAtividades(atividades, filterProfessor, filterTipo) {
    return atividades.filter((a) => {
    ...
    return (
        <section className="space-y-5">
            <AdminPageHeader
                ...
                subtitle="Calendário dos serviços agendados."
                icon={CalendarDays}
                actions={
                    <button
                        type="button"
