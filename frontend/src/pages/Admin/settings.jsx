                            ...
                            <div className="rounded-lg border border-slate-200 p-6 bg-slate-50">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <input
                                        ...
                                        className="px-4 py-3 text-base rounded-lg border border-slate-300 focus:outline-none focus:ring-2 focus:ring-york-400/50"
                                    />
                                    <input
                                        type="text"
                                ...
                                <button
                                    ...
                                    className={`flex items-center gap-2 px-6 py-3 text-white text-base rounded-lg transition font-semibold ${gestoresLoading ? 'bg-slate-400 cursor-not-allowed' : 'bg-york-400 hover:bg-york-200'}`}
                                >
                                    <Plus size={20} />
                                                    ...
                                                    return (
                                                        <tr key={gestor.id_user} className="border-b border-slate-100 last:border-0 hover:bg-slate-50 transition">
                                                            <td className="px-6 py-4 text-slate-800 font-medium">
                                                                {gestor.email}
                                                                {isCurrentUser && (
                                                                    <span className="ml-2 text-xs text-york-400 font-normal">(você)</span>
                                                                )}
                                                            </td>
                                                                ...
                                                                {!isCurrentUser && (
                                                                    <div className="flex items-center gap-2 justify-end">
                                                                        <button
                                                                            ...
                                                                            className="p-2 text-slate-500 hover:text-york-400 hover:bg-slate-100 rounded-lg transition"
                                                                        >
                                                                            {gestor.status
