...
VALUES
    ...
    ('operacional', 'reagendamento-pendente', 'Novo pedido de reagendamento', 'Um professor submeteu um novo pedido de reagendamento de sessão.', 'CalendarClock', true, false, false, true, 85)
